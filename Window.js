class Window {
     ...
     */
    getStartTime() {
        console.log("I come to getStartTime");
     ...
     */
    startsAfter(win) {
        console.log(this.getStartTimeInMs());
        console.log(win.getStartTime());
        return this.getStartTimeInMs() >= win.getStartTimeInMs();
    }
    ...
    isCompletelyDuring(win) {
        // If a given window starts after 'window' and ends before 'window'
        console.log("complete during");
        console.log(win);
        return this.startsAfter(win) && win.endsAfter(this);
    }

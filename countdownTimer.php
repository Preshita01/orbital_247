...
<html>
  <head>
    ...
    <form action="../includes/completed.inc.php" method="POST" id="completedForm">
    <style>
      p {
        display: inline;
  ...
  <body>
      ...
      <button type="button" id="pause" onclick="pauseFunction()">Pause</button>
      ...
      <script>
        ...
        var taskCat = localStorage.getItem("taskCat");
        ...
        function run_clock(endtime){
          ...
          function update_clock(){
            ...
            if(t.total <= 0) { 
                ...
                window.alert("If you are done with the task, please click 'Completed Task'. Otherwise, you may wish to click 'Cancel and Exit' to return to the main schedule, after which you can reschedule this task to another time to complete it.");
            }
          }
        ...
        function completed() {
          if (document.getElementById("reschedule").innerHTML == "Completed Task") {
            ...
            // pause_clock();
            // let t = time_remaining(endtime);
            // let timeSpent = countdown - t.total;
            // if (timeSpent < 60000) {
            //   timeSpent = 60000;
            // }
            ...
            startHour.value = startTimeHour;
            startHour.name = "startHour";
            completedForm.appendChild(startHour);

            let startMin = document.createElement("input");
            startMin.type = "hidden";
            startMin.value = startTimeMin;
            startMin.name = "startMin";
            completedForm.appendChild(startMin);

            // let addTime = document.createElement("input");
            // addTime.type = "hidden";
            // addTime.value = Math.round(timeSpent / 1000);
            // addTime.name = "addTime";
            // completedForm.appendChild(addTime);
